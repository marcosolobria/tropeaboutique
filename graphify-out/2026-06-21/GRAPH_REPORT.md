...
## Corpus Check
- Corpus is ~16,955 words - fits in a single context window. You may not need a graph.

## Summary
- 88 nodes · 107 edges · 21 communities (15 shown, 6 thin omitted)
- Extraction: 73% EXTRACTED · 25% INFERRED · 2% AMBIGUOUS · INFERRED: 27 edges (avg confidence: 0.89)
- Token cost: 159,570 input · 0 output
...
## Knowledge Gaps
- **23 isolated node(s):** `DEMO_PRODUCTS`, `products`, `BOUTIQUE Subtitle Tagline`, `Brand Color Palette (mint green gradient + pink F4A7B9 accent)`, `launch.json (Dev Server Launch Config)` (+18 more)
